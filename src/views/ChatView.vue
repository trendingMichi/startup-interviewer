        ...
        >
          ...
          <div class="pt-5">
            <p class="text-xl text-muted-foreground">
              Starte hier dein AI-Interview mit Trending Topics. Voll
              automatisiert!
            </p>
          </div>
          ...
          <div class="flex items-center space-x-2 pt-20 pb-5">
            ...
            >
              ...
              <u
                ><a
                  href="https://www.trendingtopics.eu/datenschutz/"
                  target="_blank"
                  >Datenschutzerklärung</a
                ></u
              >
              gelesen und verstanden, dass der Inhalt dieses Interviews von der
              ausgewählten AI (+ dessen Anbieter) und Trending Topics
              verarbeitet wird.
            </label>
          </div>
          <div class="">
        ...
        <Card class="w-[70rem]">
          ...
          <CardFooter>
            <div class="flex justify-center w-full">
              <div
                class="text-sm text-muted-foreground flex justify-between w-[50%]"
              >
                <p>
                  <a
                    href="https://www.trendingtopics.eu/imprint/"
                    target="_blank"
                    >Impressum</a
                  >
                </p>
                ...
                <p>
                  <a href="https://newsrooms.ai/" target="_blank"
                    >newsrooms.ai</a
                  >
                </p>
              </div>
